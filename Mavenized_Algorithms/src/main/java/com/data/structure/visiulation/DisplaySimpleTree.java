...
public DisplaySimpleTree(MyTree1 t) {
 panel = new DisplayPanel1(t);
...
public static void main(String[] args) {
 ...
 MyTree1 t = new MyTree1(); // t is Binary tree we are displaying
...
class DisplayPanel1 extends JPanel {
 ...
 public DisplayPanel1(MyTree1 t) {
 ...
 protected void paintComponent(Graphics g) {
   ...
   public void drawTree(Graphics g, Node2 root) {//actually draws the tree
   int dx, dy, dx2, dy2;
...
//traverses tree and computes x,y position of each node, stores it in the node
 ...
 public void inorder_traversal(Node2 t, int depth) { 
   if (t != null) {
...
/* below is standard Binary Search tree insert code, creates the tree */
 ...
 public Node2 insert(Node2 root, String s) { // Binary Search tree insert
   if (root == null) {
     root = new Node2(s, null, null);
     return root;
   }
   else {
...
class Node2 {  //standard Binary Tree node
 Object data;
 Node2 left;
 Node2 right;
 ...
 Node2(String x, Node2 l, Node2 r) {
   left = l;
   right = r;
   data = (Object) x;
 }
